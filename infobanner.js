AFRAME.registerComponent("info-banner", {
    ...
    createBanner: function () {
      postersInfo = {
        superman:{
            banner_url:"./bannerimages/supermanbanner.jpg",
            title:"Superman",
            released_year:"1983",
            description:
        ...
        spiderman:{
            banner_url:"./bannerimages/spidermanbanner.jpg",
            title:"Spiderman",
            released_year:"1962",
            description:
        ...
        justiceleague:{
            banner_url:"./bannerimages/justiceleaguebanner.jpg",
            title:"Justice League",
            released_year:"1962",
            description:
            "The Justice League is a DC Comics group of superheroes that includes those such as Superman, Batman, Wonder Woman, Aquaman, The Flash, and Green Lantern among others."
        },
        avengers:{
            banner_url:"./bannerimages/avengersbanner.jpg",
            title:"The Avengers",
            released_year:"1963",
            description:
            "The Avengers are a group of superheroes owned my Marvel Comics that includes those such as Spider-Man, Iron Man, The Incredible Hulk, Thor, Captain America, among others.",
        },
      };
